  ...
  return (
    <div className={clsx('flex items-center justify-center', className)}>
      <div
        ...
        className={clsx(
          'inline-flex items-center justify-center rounded-xl bg-white border border-[var(--color-secondary-outline)] h-11 p-1',
          innerClassName
        )}
      >
        {items.map((item) => {
          ...
          return (
            <button
              ...
              className={clsx(
                'cursor-pointer h-9.5 min-w-9.5 px-3 rounded-xl',
